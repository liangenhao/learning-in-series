 ...
 * @author enhao
 */
public class ExclusiveGatewaySample {
    /**
     * 流程定义key，bpmn文件的id
     */
    private static String processDefinitionKey = "holiday_exclusiveGateway";
    ...
    private static void deployProcessDefinition() {
        ...
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("diagram/holiday_exclusiveGateway.bpmn")
                .name("请假单审批流程-排他网关")
                .deploy();
